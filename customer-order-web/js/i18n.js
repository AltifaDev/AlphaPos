export const translations = {
            th: {
                ...
                staffApprovalWaitingTitle: "กำลังรอพนักงานยืนยัน",
                staffApprovalWaitingDesc: "แจ้งพนักงานให้ยืนยันการเปิดโต๊ะนี้ แล้วเมนูจะเปิดโดยอัตโนมัติ",
                staffApprovalWaitingFooter: "กรุณารอสักครู่ ไม่ต้องสแกน QR ซ้ำ",
                tableParamMissingTitle: "ไม่พบรหัสโต๊ะอาหาร",
                tableParamMissingDesc: "กรุณาสแกน QR Code บนโต๊ะอาหารของคุณเพื่อเริ่มสั่งอาหาร",
                merchantParamMissingTitle: "ไม่พบรหัสร้านค้า",
                merchantParamMissingDesc: "QR Code ไม่มีรหัสร้านค้า กรุณาสแกน QR บนโต๊ะอีกครั้ง หรือติดต่อพนักงาน",
                configMissingTitle: "ไม่สามารถโหลดการตั้งค่าได้",
                configMissingDesc: "ระบบสั่งอาหารยังไม่พร้อมใช้งาน กรุณารีเฟรชหน้าหรือสแกน QR Code ใหม่",
                configRetry: "ลองอีกครั้ง",
                qrServiceUnavailableTitle: "ระบบตรวจสอบ QR ขัดข้องชั่วคราว",
                qrServiceUnavailableMessage: "ขณะนี้ยังไม่สามารถเชื่อมต่อระบบของร้านได้ QR Code ของคุณอาจยังใช้งานได้ กรุณาลองอีกครั้ง",
                qrServiceUnavailableFooter: "หากยังไม่สำเร็จ กรุณาแจ้งพนักงานพร้อมรหัสอ้างอิงจากระบบ",
                ...
                billTotal: "ยอดรวมทั้งสิ้น",
                inclusiveTax: "รวมในราคา",
                ...
                staffApprovalDesc: "ออเดอร์รอยืนยันโดยพนักงานเสิร์ฟก่อนส่งเข้าห้องครัว",
                ...
                pushOrderReadyTitle: "อาหารพร้อมแล้ว! 🔔",
                pushOrderReadyBody: "ออเดอร์ของคุณพร้อมเสิร์ฟแล้ว",
                pushOrderServedTitle: "ทานให้อร่อยนะคะ! 🍽️",
                pushOrderServedBody: "ออเดอร์ของคุณถูกเสิร์ฟแล้ว",
                pushOrderCancelledTitle: "ออเดอร์ถูกยกเลิก",
                pushOrderCancelledBody: "ออเดอร์ของคุณถูกยกเลิก กรุณาติดต่อพนักงาน",
            },
            en: {
                // Onboarding Step 1
                ...
                staffApprovalWaitingTitle: "Waiting for staff approval",
                staffApprovalWaitingDesc: "Please ask a staff member to confirm this table. The menu will open automatically.",
                staffApprovalWaitingFooter: "Please wait. You do not need to scan the QR code again.",
                ...
                merchantParamMissingTitle: "Store Not Found",
                merchantParamMissingDesc: "This QR code is missing a store ID. Please scan the table QR again or ask staff for help.",
                configMissingTitle: "Unable to Load Settings",
                configMissingDesc: "Ordering is not ready yet. Please refresh the page or scan the QR code again.",
                configRetry: "Try Again",
                qrServiceUnavailableTitle: "QR verification is temporarily unavailable",
                qrServiceUnavailableMessage: "We cannot reach the restaurant system right now. Your QR code may still be valid. Please try again.",
                qrServiceUnavailableFooter: "If the problem continues, please ask staff for help and provide the reference code.",
                ...
                staffApprovalDesc: "Order requires staff confirmation before entering the kitchen.",
                ...
                pushOrderReadyTitle: "Order Ready! 🔔",
                pushOrderReadyBody: "Your order is ready to be served.",
                pushOrderServedTitle: "Enjoy your meal! 🍽️",
                pushOrderServedBody: "Your order has been served.",
                pushOrderCancelledTitle: "Order Cancelled",
                pushOrderCancelledBody: "Your order has been cancelled. Please contact staff.",
            ...
            zh: {
                ...
                staffApprovalWaitingTitle: "正在等待员工确认",
                staffApprovalWaitingDesc: "请让员工确认此桌，菜单随后会自动打开。",
                staffApprovalWaitingFooter: "请稍候，无需再次扫描二维码。",
                tableParamMissingTitle: "未找到桌号",
                tableParamMissingDesc: "请扫描餐桌上的二维码开始点餐。",
                merchantParamMissingTitle: "未找到店铺",
                merchantParamMissingDesc: "此二维码缺少店铺信息。请重新扫描餐桌二维码或联系店员。",
                configMissingTitle: "无法加载设置",
                configMissingDesc: "点餐系统尚未就绪。请刷新页面或重新扫描二维码。",
                configRetry: "重试",
                qrServiceUnavailableTitle: "二维码验证服务暂时不可用",
                qrServiceUnavailableMessage: "目前无法连接餐厅系统。您的二维码可能仍然有效，请重试。",
                qrServiceUnavailableFooter: "如果问题持续，请联系店员并提供系统参考编号。",
                ...
                staffApprovalDesc: "订单需由服务员确认后送入厨房。",
                ...
                pushPickUp: "请取餐",
                pushOrderReadyTitle: "订单已就绪！🔔",
                pushOrderReadyBody: "您的订单已准备好，即将为您上菜。",
                pushOrderServedTitle: "请慢用！🍽️",
                pushOrderServedBody: "您的订单已上菜。",
                pushOrderCancelledTitle: "订单已取消",
                pushOrderCancelledBody: "您的订单已取消，请联系服务员。",
            }
        }
