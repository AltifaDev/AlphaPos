...
let testInput = "2026-06-12 17:22:57.192928+00"
if let date = parseDate(testInput) {
    print("SUCCESS: Parsed '\(testInput)' to \(date)")
} else {
    print("FAILED: Could not parse '\(testInput)'")
}
